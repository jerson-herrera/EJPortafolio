...
import { frameworksLibrerias } from '../../Components/Datos/AboutFrameworkdData';
  ...
  return (
    <div id='about' className='about-page'>
      <div className='about-container'>
        ...
        <div className='about-frameworksLibrerias'>
          {frameworksLibrerias.map((data, index) => (
            <TechIconsComponent key={index} logos={data.techIcons} title="Frameworks y librerias" />
          ))}
        </div>
      </div>
    </div>
